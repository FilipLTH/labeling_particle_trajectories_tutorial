function int_output = coordinate_to_pixel_y(coordinate,channelSize,imageSize)
%COORDINATE_TO_PIXEL
...
output = imageSize/2 + from_center_on_image; % Coordinate systems are different on axis (hence the plus sign)
